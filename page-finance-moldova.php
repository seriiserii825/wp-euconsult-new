...
<?php if (have_posts()): ?>
    ...
    <div class="finance-country">
        ...
        <section class="our-services-intro section-dark page-intro finance-country" style="background-image: url('<?php echo $ramb_bg_img_src; ?>'); background-position: center top">
